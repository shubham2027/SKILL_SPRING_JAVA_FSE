...
-- Create table country with columns co_code and co_name
...
-- =========================================================================
-- Hands-on 2: Stock Data Schema and Inserts
-- =========================================================================
...
-- FB Stock Details for September 2019
...
-- Google Stock Details with stock price > 1250
...
-- Top 3 dates with highest volume (overall)
...
-- Top 3 dates with lowest stock price for Netflix (NFLX)
...
-- =========================================================================
-- Hands-on 3: Payroll Schema and Mock Data
-- =========================================================================
...
INSERT INTO `department` (dp_id, dp_name) VALUES (1, 'IT'), (2, 'HR'), (3, 'Finance');
INSERT INTO `employee` (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) VALUES
(1, 'John Doe', 50000.0, 1, '1990-05-15', 1),
(2, 'Jane Smith', 60000.0, 1, '1992-08-20', 1),
(3, 'Bob Johnson', 45000.0, 0, '1995-12-10', 2);

INSERT INTO `skill` (sk_id, sk_name) VALUES (1, 'Java'), (2, 'SQL'), (3, 'Spring Boot');
INSERT INTO `employee_skill` (es_em_id, es_sk_id) VALUES (1, 1), (1, 2), (2, 1);
